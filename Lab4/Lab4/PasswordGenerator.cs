...
namespace PasswordGenerator
{
    internal class PasswordGenerator
    {
        ...
        private async Task<List<string>> GenRecsInternAsynch(int count)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                switch (rnd.Next(0, 11))
                {
                    case 1:
                        ...
                        break;
                    case 2:
                        result.Add(await Task.Run(() => CreateTrulyRandomPassword()));
                        break;
                    default:
        ...
        internal Task<List<string>> GenerateRecordsAsync(int count)
        {
            ...
            return GenRecsInternAsynch(count);
        }
        private string CreateTrulyRandomPassword()
        {
