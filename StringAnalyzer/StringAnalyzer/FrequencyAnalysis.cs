...
namespace CipherBreaker
{
    public  class FrequencyAnalysis
    {
        ...
        public static readonly string quadPath = "D://Folya//docs//homeworks//7 sem//security//english_quadgrams.txt";
        public static readonly string textPath = "D://Folya//docs//homeworks//7 sem//security//lab1_xt.txt";
        /// <summary>
        ...
        static FrequencyAnalysis()
        {
            ...
            var lines = File.ReadAllLines(quadPath);
